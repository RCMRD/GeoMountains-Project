...
Acacia_models <- BIOMOD_Modeling(
                                  Acacia_data,
                                  modeling.id = "demo1",
                                  models = c("GLM", "GBM", "RF", "GAM"), #GAM failed during this step.
...
write.csv(Acacia_models_scores, file.path(outPath, "csvs/Acacia_2.0/Acacia_models_scores.csv"), row.names = FALSE)
...
ggsave(file.path(outPath, "plots/Acacia_2.0/plotByALGO.png"), plot = plotByALGO$plot, width = 8, height = 6)
# Export the statistics as a csv file (e.g., CSV)
write.csv(plotByALGO$tab, file.path(outPath, "csvs/Acacia_2.0/plotByALGO.csv"), row.names = FALSE)
...
plotByRUN
# Export the plot as an image file (e.g., PNG)
ggsave("../outputs/plots/Acacia_2.0/plotByRUN.png", plot = plotByRUN$plot, width = 8, height = 6)
# Export the statistics as a csv file (e.g., CSV)
write.csv(plotByRUN$tab, file.path(outPath, "csvs/Acacia_2.0/plotByRUN.csv"), row.names = FALSE)
...
plotByPA
# Export the plot as an image file (e.g., PNG)
ggsave(file.path(outPath, "plots/Acacia_2.0/plotByPA.png"), plot = plotByPA$plot, width = 8, height = 6)
# Export the statistics as a csv file (e.g., CSV)
write.csv(plotByPA$tab, file.path(outPath, "csvs/Acacia_2.0/plotByPA.csv"), row.names = FALSE)
...
# Export the statistics as a csv file (e.g., CSV)
write.csv(Acacia_models_var_import, file.path(outPath, "csvs/Acacia_2.0/Acacia_models_variable_importance.csv"), row.names = FALSE)
...
# Export the statistics as a csv file (e.g., CSV)
write.csv(mean_VariableImportance, file.path(outPath, "csvs/Acacia_2.0/Acacia_models_mean_VariableImportance.csv"), row.names = FALSE)
...
# Export the plot as an image file (e.g., PNG)
ggsave(file.path(outPath, "plots/Acacia_2.0/Generalized Linear Model.png"), plot = glm_eval_strip$plot, width = 12, height = 8)
...
# Export the plot as an image file (e.g., PNG)
ggsave(file.path(outPath, "plots/Acacia_2.0/Generalized Boosted Regression Model.png"), plot = gbm_eval_strip$plot, width = 12, height = 8)
...
# Export the plot as an image file (e.g., PNG)
ggsave(file.path(outPath, "plots/Acacia_2.0/Random Forest Model.png"), plot = rf_eval_strip$plot, width = 12, height = 8)
...
# ---- Write the selected data to a CSV file under the specified directory
write.csv(Acacia_models_selection_scores, file.path(outPath, "csvs/Acacia_2.0/Acacia_models_selection_scores.csv"), row.names = FALSE)
...
plotSelectByALGO                          
# Export the plot as an image file (e.g., PNG)
ggsave(file.path(outPath, "plots/Acacia_2.0/plotSelectByALGO.png"), plot = plotSelectByALGO$plot, width = 8, height = 6)
# Export the statistics as a csv file (e.g., CSV)
write.csv(plotSelectByALGO$tab, file.path(outPath, "csvs/Acacia_2.0/plotSelectByALGO.csv"), row.names = FALSE)
...
plotSelectByRUN
# Export the plot as an image file (e.g., PNG)
ggsave("../outputs/plots/Acacia_2.0/plotSelectByRUN.png", plot = plotSelectByRUN$plot, width = 8, height = 6)
# Export the statistics as a csv file (e.g., CSV)
write.csv(plotSelectByRUN$tab, file.path(outPath, "csvs/Acacia_2.0/plotSelectByRUN.csv"), row.names = FALSE)
...
plotSelectByPA
# Export the plot as an image file (e.g., PNG)
ggsave(file.path(outPath, "plots/Acacia_2.0/plotSelectByPA.png"), plot = plotSelectByPA$plot, width = 8, height = 6)
# Export the statistics as a csv file (e.g., CSV)
write.csv(plotSelectByPA$tab, file.path(outPath, "csvs/Acacia_2.0/plotSelectByPA.csv"), row.names = FALSE)
...
# Export the statistics as a csv file (e.g., CSV)
write.csv(Acacia_models_selection_var_import, file.path(outPath, "csvs/Acacia_2.0/Acacia_models_selection_variable_importance.csv"), row.names = FALSE)
...
# Export the statistics as a csv file (e.g., CSV)
write.csv(mean_VariableImportance_selection, file.path(outPath, "csvs/Acacia_2.0/Acacia_models_selection_mean_VariableImportance.csv"), row.names = FALSE)
...
# Export the plot as an image file (e.g., PNG)
ggsave(file.path(outPath, "plots/Acacia_2.0/Random Forest Model (selection).png"), plot = rf_eval_selection$plot, width = 12, height = 8)
...
# Export the plot as an image file (e.g., PNG)
ggsave(file.path(outPath, "plots/Acacia_2.0/Generalized Boosted Regression Model (selection).png"), plot = gbm_eval_selection$plot, width = 12, height = 8)
...
# Export the plot as an image file (e.g., PNG)
ggsave(file.path(outPath, "plots/Acacia_2.0/RCP 2.6 (caMEANwm).png"), plot = emCAmeanWM_2.6, width = 12, height = 8)
...
# Export the plot as an image file (e.g., PNG)
ggsave(file.path(outPath, "plots/Acacia_2.0/RCP 8.5 (caMEANwm).png"), plot = emCAmeanWM_8.5, width = 12, height = 8)
...
write.csv(SRC_current_2050_BC26$Compt.By.Models, file.path(outPath, "csvs/Acacia_2.0/SRC_current_2050_BC26-Compt.By.Models.csv"), row.names = FALSE)
...
write.csv(SRC_current_2050_BC85$Compt.By.Models, file.path(outPath, "csvs/Acacia_2.0/SRC_current_2050_BC85-Compt.By.Models.csv"), row.names = FALSE)
...
ggsave(file.path(outPath, "plots/Acacia_2.0/RCP 2.6 (DiffByPixel).png"), plot = diffByPixel2.6, width = 8, height = 6)
...
# Export the plot as an image file (e.g., PNG)
ggsave(file.path(outPath, "plots/Acacia_2.0/RCP 8.5 (DiffByPixel).png"), plot = diffByPixel8.5, width = 8, height = 6)
...
##ggsave(file.path(outPath, "plots/Acacia_2.0/speciesRangeChangeCountPlot2.6.png"), plot = speciesRangeChangePlots2.6$count, width = 8, height = 6, units = "in")
...
##ggsave(file.path(outPath, "plots/Acacia_2.0/speciesRangeChangePercentagePlot2.6.png"), plot = speciesRangeChangePlots2.6$percentage, width = 8, height = 6, units = "in")
#-----------SRC models maps representing spatially locations (pixels) lost, stable and gained for each single distribution model
##ggsave(file.path(outPath, "plots/Acacia_2.0/speciesRangeChangeMapsPlot2.6.png"), plot = speciesRangeChangePlots2.6$maps, width = 8, height = 6, units = "in")
...
# Export the plot as an image file (e.g., PNG)
ggsave(file.path(outPath, "plots/Acacia_2.0/meanEvalScores_caliFN.png"), plot = meanEvalScores_caliFN$plot, width = 8, height = 6)
...
# Export the plot as an image file (e.g., PNG)
ggsave(file.path(outPath, "plots/Acacia_2.0/meanEvalScores_caliAlgo.png"), plot = meanEvalScores_caliAlgo$plot, width = 8, height = 6)
...
# Export the plot as an image file (e.g., PNG)
ggsave(file.path(outPath, "plots/Acacia_2.0/meanEvalScores_valiFN.png"), plot = meanEvalScores_valiFN$plot, width = 8, height = 6)
...
# Export the plot as an image file (e.g., PNG)
ggsave(file.path(outPath, "plots/ACacia_2.0/meanEvalScores_valiAlgo.png"), plot = meanEvalScores_valiAlgo$plot, width = 8, height = 6)
